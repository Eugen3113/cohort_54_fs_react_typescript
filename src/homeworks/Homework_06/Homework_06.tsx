...
function Homework_06() {
  const cars: Car[] = [                    //! типизируем массив объектов (interface  или  type для объектов)
  ...
  const carCards: ReactNode = cars.map((car: Car) => {           //типизируем (car: Car)
    return (                          // key={v4()}  - чтобы в консоли небыло ошибки
