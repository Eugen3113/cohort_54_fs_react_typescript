...
function Lesson_06() {
  ...
  /////////////////////////////////////////////////////////////////////////////////
  // 7. any - любой (например приходят неизвестные данные с сервера)
  let anyVariable: any = "hello";
  anyVariable = 300;
  anyVariable = true;

  ///////////////////////////////////////////
  // 8. null и undefined , можно несколько | -использовать
  ...
  interface User extends Admin {  // можно расширять интерфейс(extends Admin) User использует св-ва Admin.
    firstName: string;
    lastName: string;
    age: number;
    job: string;
    pet?: string;              // pet?  - c ? ключ необязателен 
  }
