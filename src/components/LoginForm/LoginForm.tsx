...
function LoginForm() {
  ...
  const formik = useFormik({
    initialValues: {                         // Значение по умолчанию(name: "")
    ...
    onSubmit: (values, helpers ) => {
      ...
      console.log(values);
      //helpers- Вспомогательные функции, которые мы можем использовать во время события submit
  ...
  return (
    // formik.handleSubmit - мы прописываем для того, чтобы когда мы нажали на кнопку c type="submit",
    ...
    <LoginFormContainer onSubmit={formik.handleSubmit}>
      ...
      <InputsContainer>
        <Input
          ...
          onChange={formik.handleChange}      //! handleChange -контролирует ввод пользователя под капотом
